...
import com.gamingroom.gameauth.auth.*;
...
public class GameAuthApplication extends Application<Configuration> {
    ...
    public void run(Configuration c, Environment e) throws Exception {
        ...
        // FIXME: register GameUserRESTController
        e.jersey().register(GameUserRESTController.class);

        // FIXME: Create io.dropwizard.client.JerseyClientBuilder instance and give it io.dropwizard.setup.Environment reference
        JerseyClientBuilder jerseyClientBuilder = new JerseyClientBuilder(e);
        Client client = jerseyClientBuilder.build("client");
